...
function Home() {
  ...
  const [chat] = React.useState<Chat[]>([
    ...
    {type:"agent", msg:"Thank you. Let me check your policy details. It may take a moment.", agentName:""},
    ...
    {type:"agent", msg:"Understood. Let me update your policy to include those additional coverages. It may take a moment to process", agentName:""},
